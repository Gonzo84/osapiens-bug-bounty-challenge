      ...
      <Container>
        ...
        <Typography
          ...
          dangerouslySetInnerHTML={{
            __html: DOMPurify.sanitize(`${t("home.intro")} `),
          }}
        ></Typography>
        ...
        <List>
          {issues.map((issue, index) => (
            // To use index for a key is fine if the elements do not get removed or added to 'issues' list, but if they do then you will have weird side-effects as React will associate the keys with wrong components
